...
class MyGUI:
    ...
    def live_feed(self):
        ...
        self.canvas = tk.CTkCanvas(self.canvas_frame, width=640, height=480)
        self.canvas.pack(expand=True, fill="both", side="top")

        #Create a new frame for subwindows
        self.subwindows = tk.CTkFrame(self.select_live_feed)
    ...
    def update_frame(self):
        ...
        if ret:
            ...
            self.photo = tkinter.PhotoImage(data=cv2.imencode('.png', self.photo)[1].tobytes())
    ...
    def import_video(self):
        ...
        self.analyze_button = tk.CTkButton(self.buttons_frame, text="Analyze Video", command=self.analyze_video)
    ...
    def analyze_video(self):
        ...
        new_window = tk.CTkToplevel(self.window)
        new_window.title("Analyze Window")
